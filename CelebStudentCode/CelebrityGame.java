...
public class CelebrityGame
{
    ...
    Celebrity JTrudeau = new Celebrity("Justin Trudeau","man funny guy");
    ...
    public void prepareGame()
    {
        ...
        celebGameList.add(JTrudeau);
        celebGameList.add(ping);
        gameCelebrity.setClue(ping.getClue());
        gameCelebrity.setAnswer(ping.getAnswer());
